...
urlpatterns = [
    re_path(r'^get_data_sources', user_ajax.get_data_source_list_oaipmh,
            name='core_explore_oaipmh_app_get_data_sources'),
    re_path(r'^update_data_sources', user_ajax.update_data_source_list_oaipmh,
            name='core_explore_oaipmh_app_update_data_sources'),
    re_path(r'^data', user_views.data_detail,
